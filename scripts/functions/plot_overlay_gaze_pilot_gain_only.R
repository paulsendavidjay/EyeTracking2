...
################################################################################################
	...
	if (trialType == 1)	{
		...
		rect(current_positions[[1]][[1]][1], current_positions[[1]][[2]][1], current_positions[[1]][[1]][2], current_positions[[1]][[2]][2], col="NA", border="green4", lwd=1)
		rect(current_positions[[2]][[1]][1], current_positions[[2]][[2]][1], current_positions[[2]][[1]][2], current_positions[[2]][[2]][2], col="NA", border="orange4", lwd=1)
		rect(current_positions[[3]][[1]][1], current_positions[[3]][[2]][1], current_positions[[3]][[1]][2], current_positions[[3]][[2]][2], col="NA", border="green3", lwd=1)
		rect(current_positions[[4]][[1]][1], current_positions[[4]][[2]][1], current_positions[[4]][[1]][2], current_positions[[4]][[2]][2], col="NA", border="orange1", lwd=1)
		...
		if (current_gamble == 1) { 
			...
			ymin <- min(current_positions[[3]][[2]][1], current_positions[[4]][[2]][1])
			ymax <- max(current_positions[[3]][[2]][2], current_positions[[4]][[2]][2])

			rect(xmin - choiceMargin, ymin - choiceMargin, 
				xmax + choiceMargin, ymax + choiceMargin, 
				col="NA", lty="dashed", border="gray50", lwd=1)
			
			if (current_coinsWon == s1) {
				outcome_frame_pos <- 3
			} else {
				outcome_frame_pos <- 4				
			}
