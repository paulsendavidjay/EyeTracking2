...
emot_decay_Gain_model3_rrrrde <- function(decay_temp, trial, choice, outcome, mag1.prop, mag2.prop, sure2.prop, output_type, decay_type) {
	...
	for (i in 1:n_obs) {
		...
		if (outcome[i] == 2) { #WINS
			...
			disappointment[i] <- mag1.prop[i] # [counterfactual outcome]
